...
<div className="col-12 md:col-6 field mt-5">
        <span className="align-items-center">
            ...
            <Calendar id="createdDate" value={_entity?.createdDate ? new Date(_entity?.createdDate) : new Date()} onChange={ (e) => setValByKey("createdDate", new Date(e.target.value))} showIcon showButtonBar  inline showWeek  />
        </span>
        </div>
